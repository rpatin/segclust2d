...
author: "Rémi Patin - remi.patin@cefe.cnrs.fr"
date: "`r Sys.Date()`"
output: 
...
devtools::load_all() # used for building the vignette
# library(segtools) # needs to be run for the following code to work.
```
